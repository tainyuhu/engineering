...
# 施工項目
class PV_TaskModel(models.Model):
...
# 工程項目
class PV_ProjectModel(models.Model):
...
# PV 分項權重
class PV_SubItemWeightModel(models.Model):
    # id = models.CharField('編號', max_length=50, primary_key=True)
...
# PV 細項權重
class PV_DetailedItemWeightModel(models.Model):
    # id = models.CharField('編號', max_length=50, primary_key=True)
...
# PV 預期進度
class PV_ExpectedProgressModel(models.Model):
    # id = models.CharField('編號', max_length=50, primary_key=True)
    # 工程識別碼
...
# PV 工程進度
class PV_ProgressModel(models.Model):
    # id = models.CharField('編號', max_length=50, primary_key=True)
    # 預期識別碼 
