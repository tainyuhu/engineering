...
from .models import (
    Billboard, FileProgressMonth, FileProgressPhase, MeetingRecord, ProjectValueRatio, ProjectValueRatiosHistory, Plan, PlansHistory,
...
# 文件連結管理
class FileProgressPhaseSerializer(serializers.ModelSerializer):
    class Meta:
        model = FileProgressPhase
        fields = '__all__'

# 文件連結管理
class FileProgressMonthSerializer(serializers.ModelSerializer):
    class Meta:
        model = FileProgressMonth
        fields = '__all__'
