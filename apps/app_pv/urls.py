...
urlpatterns = [
    ...
    # 計算Loop周進度
    path('get_loop_progress/<int:loop_id>/<int:currentPage>/<int:itemsPerPage>/<str:project_type>/', views.GetLoopProgress.as_view(), name='get_loop_progress'),
    # 計算Loop所有季進度
    path('get_loop_all_quarter_progress/<int:loop_id>/<int:currentPage>/<int:itemsPerPage>/<str:project_type>/', views.GetLoopAllQuarterProgress.as_view(), name='get_loop_all_quarter_progress'),
    # 計算Loop季進度
    path('get_loop_quarter_progress/<int:loop_id>/<int:currentPage>/<int:itemsPerPage>/<str:project_type>/', views.GetLoopQuarterProgress.as_view(), name='get_loop_quarter_progress'),
    # 計算季進度報表
    ...
    # 計算所有季進度報表
    path('get_pv_all_quarter_chart_progress/<int:loop_id>/<str:project_type>/', views.GetPVAllQuarterChartProgress.as_view(), name='get_pv_all_quarter_chart_progress'),
    # 計算周進度報表
